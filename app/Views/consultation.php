...
<body class="home-1">
    ...
    <section class="petgrooming-content padding-top-custom">
        ...
        <div class="container text-center">
            <h2 class="section-title">Caring Consultations with Certified Vets</h2>

            <h2 class="section-title-2">because peace of mind starts with expert advice</h2>
            ...
            <div class="row justify-content-center mt-4">
                ...
                <div class="col-lg-3 col-md-6 mb-4">
                    <div class="service-item">
                        ...
                        <div class="service-text">
                            <h5 class="service-title">Book a Vet Instantly</h5>
                            <p class="service-description">Easily schedule consultations with trusted veterinary doctors
                                - just pick your pet, choose a doctor, and confirm a slot.</p>
                        </div>
                    </div>
                </div>
                <!-- Service Item 2 -->
                <div class="col-lg-3 col-md-6 mb-4">
                    <div class="service-item">
                        ...
                        <div class="service-text">
                            <h5 class="service-title">Flexible Time Slots</h5>
                            <p class="service-description">Convenient appointment slots let you choose what works best.
                                No queues, no clinic visits - 100% online booking.</p>
                        </div>
                    </div>
                </div>
                <!-- Service Item 3 -->
                <div class="col-lg-3 col-md-6 mb-4">
                    <div class="service-item">
                        ...
                        <div class="service-text">
                            <h5 class="service-title">Direct Chat with Doctors</h5>
                            <p class="service-description">Once booked, your selected doctor will connect with you via
                                in-app chat or messaging for personalized guidance.
                ...
                <div class="col-lg-3 col-md-6 mb-4">
                    <div class="service-item">
                        ...
                        <div class="service-text">
                            <h5 class="service-title">Expert Advice, Anytime</h5>
                            <p class="service-description">From routine checkups to urgent queries, our certified vets
                                are here to support your pet’s health - whenever you need them.
        ...
        <div class="zigly-home-section-wrapper">
            ...
            <div class="left">
                <div class="left-content">
                    ...
                    <h3>Get expert vet advice <br>from trusted doctors <br>right from the <br>comfort of your home</h3>

                    <div class="book-appoinment-2">
                        <button class="appoinment" type="submit"> <a href="<?= base_url('booking') ?>">BOOK
        ...
        <div class="container-fluid">
            ...
            <div id="everyday" class="package-container">
                ...
                <div class="package-details">
                    ...
                    <p class="description">
                        Upon assessing your dog’s skin & coat, our groomers use suitable products, ensuring that it
                        leaves with a clean coat & ears, and trimmed paws.
                    </p>
                </div>
            </div>
            ...
            <div id="full" class="package-container" style="display: none;">
                <div class="package-image">
                    <img src="https://www.zigly.com/media/mageplaza/blog/post/resize/400x/d/o/dog_allergies.png"
                        alt="Full Grooming Spa Package Image">
                </div>
                <div class="package-details">
                    ...
                    <p class="description">
                        This package provides a complete grooming experience with spa-like relaxation, ensuring your pet
                        is pampered and groomed to perfection.
                    </p>
                </div>
            </div>
    ...
    <section class='card-section'>
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-4 mb-4">
                    <div class="card">
                        <img src="https://www.zigly.com/media/mageplaza/blog/post/resize/400x/d/r/dry_skin_in_dogs.png"
                            alt="Dry Skin in Dogs">
                        <div class="card-body">
                ...
                <div class="col-md-4 mb-4">
                    <div class="card">
                        <img src="https://www.zigly.com/media/mageplaza/blog/post/resize/400x/y/o/your_guide_to_ticks_fleas_in_pets_symptoms_treatment_care.jpg"
                            alt="Ticks and Fleas in Pets">
                        <div class="card-body">
    ...
    <section class="quality-section">
        ...
        <div class="container-fluid ">
            ...
            <div class="sub-heading">Your little bundle of joy will always be in good hands. Our groomers are not just
                certified but also care for your pets with all their heart. And the best part is, that your pet can
                enjoy all our services at home.</div>
            ...
            <div class="content-section">
                <div class="content-card">
                    ...
                    <div class="content-description">
                        ...
                        <p>When the question is of your pet's upkeep, our certified, pet-loving groomers ensure that
                            your pet enjoys the best-in-class services at the comfort of its home.</p>
                    </div>
                </div>
                ...
                <div class="content-card">
                    <img src="<?= base_url();?>assets/img/home_section/certified_groomers.png"
                        alt="Happy Pets, Happy Parents">
                    <div class="content-description">
                        <h5>Happy Pets, Happy Parents</h5>
                        <p>Our high-quality services address your pets' needs with the ultimate perfection! Every
                            grooming session will help them be their best, happy selves.</p>
                    </div>
                </div>
            </div>
    ...
    <script src="<?php echo base_url();?>assets/custom/js/consultation.js"></script>
