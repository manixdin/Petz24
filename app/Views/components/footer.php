                    ...
                    <div class="home5-footer">
                        <div class="f-logo">
                            <ul class="footer-ul">
                                ...
                                <p class="my-2">Lorem ipsum dolor sit amet consectetur adipisicing elit. Omnis nemo, in
                                    eveniet culpa quod deleniti illum rem consectetur obcaecati commodi, quia quas.</p>
                            ...
                            <div class="footer-link" id="footer-accordian">
                                <div class="f-link">
                                    ...
                                    <ul class="f-link-ul collapse" id="t-cate" data-bs-parent="#footer-accordian">
                                      <li class="f-link-ul-li"><a href="<?= base_url('booking') ?>">Consultation Booking</a></li>

                                                                            <li class="f-link-ul-li"><a href="<?= base_url('chatbooking') ?>">Chat with Doctor Booking</a></li>
