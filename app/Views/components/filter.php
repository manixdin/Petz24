                                                ...
                                                <ul class="dropdown-submenu mega-menu collapse"
                                                    ...
                                                    <li class="megamenu-li parent">
                                                        ...
                                                        <ul class="dropdown-supmenu collapse"
                                                            ...
                                                            <li class="supmenu-li"><a href="product.html">Oranges</a>
                                                            </li>
                                                            <li class="supmenu-li"><a href="product.html">Coffee
                                                                    creamers</a></li>
                                                            <li class="supmenu-li"><a href="product.html">Ghee
                                                    ...
                                                    <li class="megamenu-li parent">
                                                        ...
                                                        <ul class="dropdown-supmenu collapse" id="collapse-apple-menu1">
                                                            <li class="supmenu-li"><a href="product.html">Pears
                                                                    produce</a></li>
                                                            <li class="supmenu-li"><a href="product.html">Bananas</a>
                                                            </li>
                ...
                <div class="col">
                    <ul class="f-bottom">
                        ...
                        <li class="f-c f-payment">
                            <a href="checkout-1.html"><img src="image/payment.png" class="img-fluid"
                                    alt="payment image"></a>
                        </li>
                    </ul>
                </div>
