                            ...
                            <div class="row">  
                                ...
                                <div class="col-lg-12 mt-3">
                                    <div class="form-floating mb-4 floating">
                                        <input class="form-control"  id="plan_name" placeholder="Enter the pet name"  name="plan_name">
                                        <label for="plan_name"><span class='text-danger'>*</span> Plan Name</label>
                                    </div>
                                </div>
                                <div class="col-lg-12 mt-3">
                                    <div class="form-floating mb-4 floating">
                                        <input class="form-control"  id="plan_price" placeholder="Enter the pet name"  name="plan_price">
                                        <label for="plan_price"><span class='text-danger'>*</span> Plan Price</label>
                                    </div>
                                </div>
                                <div class="col-lg-12 mt-3">
                                    <div class="form-floating mb-4 floating">
                                        <input class="form-control"  id="duration" placeholder="Enter the pet name"  name="duration">
                                        <label for="duration"><span class='text-danger'>*</span> Plan Duration (in mins)</label>
                                    </div>
                                </div>
                                <div class="col-lg-12 mt-3">
                                    <div>
                                        <label for="plan_img" class="form-label"><span class='text-danger'>*</span> Plan Image &nbsp;
                                    ...
                                    <img src="" id="plan_img_url" alt="image" width="130px" style="padding-top: 15px; display:none;">
                                </div>
                            </div>
                        </div> 
