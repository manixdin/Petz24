                                ...
                                <div class="col-lg-12 mt-3">
                                    <div class="form-floating">
                                        <select class="form-select" id="petselect"
                                            aria-label="Floating label select example" name="plan_id">
                                ...
                                <div class="col-lg-12 mt-3">
                                    <div class="form-floating mb-4 floating">
                                        <input class="form-control" id="service_name"
                                            placeholder="Enter the service name" name="service_name">
                                        <label for="service_name"><span class='text-danger'>*</span> Service</label>
                                    </div>
                                </div>
                                <div class="col-lg-12 mt-3">
                                    <div class="form-floating mb-4 floating">
                                        <textarea style="height:130px;" class="form-control" row="5"
                                            id="service_details" placeholder="Enter the service details"
                                            name="service_details"></textarea>
                                        <label for="service_details"><span class='text-danger'>*</span> Service
                                            Details</label>
                                    </div>
                                </div>
                            </div>
